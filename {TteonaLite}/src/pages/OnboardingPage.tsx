...
const slides = [
  ...
  },
  {
    ...
    desc: "\"여기서 촬영\" 버튼 하나로\n오늘 방문한 장소들이 코스가 돼!",
    features: [
      { icon: "M13 2L3 14h9l-1 8 10-12h-9l1-8z", label: "즉시 기록" },
  ...
  },
  {
    img: tteoniGuide,
    title: "이 코스로 떠나기",
    desc: "다른 사람의 인기 코스를 발견하고\n따라가며 나만의 코스를 만들어봐!",
    features: [
      { icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z", label: "코스 탐색" },
      { icon: "M12 20h9M16.5 3.5a2.12 2.12 0 013 3L7 19l-4 1 1-4z", label: "코스 편집" },
      { icon: "M3 7l6-4 6 4 6-4v14l-6 4-6-4-6 4z", label: "거리 안내" },
    ],
  },
  {
    img: tteoniFont,
