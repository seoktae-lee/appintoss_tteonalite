...
function useSprings(length, props, deps) {
  ...
  const strictModeRestartSnapshot = (0, import_react2.useRef)([]);
  ...
  (0, import_shared10.useIsomorphicLayoutEffect)(() => {
    ...
    (0, import_shared10.each)(ctrls.current, (ctrl, i) => {
      ...
      const update2 = activeUpdates[i];
      if (update2) {
        replaceRef(ctrl, update2.ref);
        if (ctrl.ref) {
          ctrl.queue.push({
            ...update2,
            default: import_shared10.is.obj(update2.default) ? { ...update2.default } : update2.default
          });
        } else {
          ctrl.start(update2);
        }
...
function useTrail(length, propsArg, deps) {
  ...
  (0, import_shared13.useIsomorphicLayoutEffect)(() => {
    ...
    const unsubscribers = [];
    (0, import_shared13.each)(ctrls, (ctrl, i) => {
    ...
    return () => {
      (0, import_shared13.each)(unsubscribers, (unsubscribe) => unsubscribe());
    };
  }, deps);
